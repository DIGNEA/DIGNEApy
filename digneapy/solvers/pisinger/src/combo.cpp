...
stype maketest(int *p, int *w, int *x, item *f, item *l, int type, int r,
               int v) {
    register item *j;
    stype c;
...
void testinstance(int *p, int *w, int *x, int c, item **f, item **l, int n,
...
extern std::tuple<double, double> combo_cpp(int n, int *p, int *w, int *x,
    ...
    testinstance(p, w, x, c, &f, &l, n, r, type, v);
    z = combo(f, l, c, 0, std::numeric_limits<stype>::max(), false, false);
