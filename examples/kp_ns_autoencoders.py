...
if __name__ == "__main__":
    expected_encoders = KPEncoder._AVAILABLE_ENCODERS

    parser = argparse.ArgumentParser(
        prog="kp_ae_example",
        description="Novelty Search for KP instances with AEs.",
    )
    parser.add_argument(
        "encoder",
        choices=expected_encoders,
        type=str,
    ...
    dimension = int(encoder) if encoder != "variable" else 1000
